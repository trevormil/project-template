...
| Build/review | Call `/stacked-mr`; do not duplicate its implementation or review logic. The review checkpoint is the `code-review` agent, with `/code-review` only as a compatibility launcher. |
